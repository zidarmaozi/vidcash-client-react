        ...
        <div className={`bg-gray-800 rounded-b-2xl md:rounded-2xl p-6 mb-6 ${className}`}>
            ...
            {folder && (
                <Link 
                    ...
                    className="group bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 hover:from-violet-500/20 hover:to-fuchsia-500/20 border border-violet-500/30 rounded-xl p-4 mb-6 transition-all duration-300 hover:border-violet-500/50"
                >
